...
0d1a8af80580   postgres:13   "docker-entrypoint.s…"   11 seconds ago   Up 10 seconds   0.0.0.0:5432->5432/tcp   postgresql-docker
```
...
root@0d1a8af80580:/# psql -U postgres
...
root@0d1a8af80580:/# psql -U postgres -f /tmp/test_dump.sql  test_database
SET
SET
SET
SET
...
Можно, например прописав правила вставки:
```
...
Например, добавив свойство UNIQUE
```
